...
project = u"awesome"
copyright = u"2017, David Antliff"
author = u"David Antliff"
repo_name = u"awesome"
...
texinfo_documents = [
    (master_doc, repo_name, u'{} Documentation'.format(repo_name),
     author, repo_name, u'http://tjelvarolsson.com/blog/begginers-guide-creating-clean-python-development-environments/',
     'Miscellaneous'),
]
